...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, GEAR_UP_Pin|GEAR_DOWN_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = GEAR_UP_Pin|GEAR_DOWN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  ...
  GPIO_InitStruct.Pin = GEAR_UP_TRIGGER_Pin|GEAR_DOWN_TRIGGER_Pin;
